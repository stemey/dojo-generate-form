define([ "dojo/_base/array", "dojo/aspect", "dojo/_base/lang", "dojo/_base/declare",
	...
	"dojo/dom-construct", "./model/hasChanged", "./group/_GroupMixin", "./schema/labelHelper", "dojo/query", "dijit/registry" ], function (array, aspect, lang, declare, Container, at, domConstruct, hasChanged, _GroupMixin, labelHelper, query, registry) {
	// module:
	//		gform/Editor
