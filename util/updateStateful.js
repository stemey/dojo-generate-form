...
"dojo/Stateful"//
	...
	// summary:
	//		updates the property in the modelHandle, so that it is a Stateful instance.
	// 		If it was null then it will be an empty Stateful. If it was a Stateful then nothing 
	// 		eill be changed. 
	//
	// stateful:
