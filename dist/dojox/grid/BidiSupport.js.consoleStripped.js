define("dojox/grid/BidiSupport", ["../main", "dojo/_base/lang", "./_Builder", "dijit/_BidiSupport",
"./_Grid", "./cells/_base", "./cells/dijit"],
	function(dojox, lang, _Builder, _BidiSupport, _Grid, BaseCell, cellsDijit){
		...
		lang.extend(BaseCell.Cell, {
			...
			RLE: '\u202B',
			PDF: '\u202C',
			KEY_HANDLER: "onkeyup='this.dir = dijit._BidiSupport.prototype._checkContextual(this.value)'",
